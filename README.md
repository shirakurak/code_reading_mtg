...
今回は、そのコードを実際に読むという勉強会を実施していたので、記録として記事化します。

## 勉強会の概要

昨年、プロダクトのコードを読む勉強会を実施し、リファクタリングを行うという活動をしていました。
理解が深まり似た機能の実装スピードが上がったり、技術の伝承が行われたりなど、案外すぐ役に立つ機会となっていました。

本勉強会はその続きという立ち位置で、じゃあ次はOSS読んでみようか、という感じで始まりました。

勉強会では、以下のことに気を付けていました：
